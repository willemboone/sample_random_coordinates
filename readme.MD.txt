...
For one of my project I needed to sample latitude/longitude coordinates all over the globe. 
...
The correct method is to have random sampling in cartesian (3d) environment and reproject those to lat/lon coordinates. 
